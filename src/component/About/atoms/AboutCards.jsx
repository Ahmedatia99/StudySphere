  ...
  return (
    <main>
      <section className="grid md:grid-cols-2 gap-5 mt-14 ">
        <div className="bg-white flex flex-col justify-between items-start md:p-20lg:p-20 md:p-10 mobile:p-5  rounded-xl">
          <PiBackpackFill
        ...
        <div className="bg-white flex flex-col justify-between items-start md:p-20 lg:p-20 md:p-10 mobile:p-5  rounded-xl">
          <FaBook
            className="p-3 bg-liteorange rounded-md text-morning mb-6 border border-stroke"
            size="50px"
          />
